...
var btnDecrease = document.querySelector('#decrease'); // 2) 액션 이름 
// - 액션 이름은 문자열 형태로 만든다.
// - 대문자로 작성한다. 
// - 고유값이어야한다(중복X)
...
var DECREASE = 'DECREASE'; // 3) 액션 생성 함수
...
var store = (0, _redux.createStore)(reducer); // 7) render 함수 만들기
...
store.subscribe(render); // 9) 액션 발생시키기(Dispatch)
...
//# sourceMappingURL=/redux-test.e31bb0bc.js.map